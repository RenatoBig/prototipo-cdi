...
<?php
	...
	$objGrid -> FormatColumn("idCodigoX", "Id. Código X", 15,15, 0, "80", "center", "select:1_CDC:2_Matrícula:3_Placa:4_CNES:5_Nº do telefone");
	$objGrid -> FormatColumn("nomeFantasia", "Nome da Unidade", 50, 50, 0, "120", "left", "textarea");
	...
	$objGrid -> FormatColumn("codigoPNGC", "Código PNGC", 50, 50, 0, "100", "left", "select:SELECT id, codigoPNGC from estrutura_composicao_pngc where codigoPNGC >'4.' and  codigoPNGC < '7.'");
